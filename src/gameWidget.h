...
#define COLOR_A_DOTS 1,0,0,1
#define COLOR_B_DOTS 0,0,1,1

/// kolor mojej kropki ktora ma zostac dodana do sciezki 
#define COLOR_HOVER_NEXT_IN_PATH 0,0.6,0,1
#define COLOR_HOVERED_NEW_A 1,110.0/255,51.0/255, 1
#define COLOR_HOVERED_NEW_B 0,110.0/255,1, 1
#define COLOR_A_BASE_BG 1,0,0,0.2
#define COLOR_A_BASE_PATH 1,0,0,0.8
#define COLOR_B_BASE_BG 0,0,1,0.2
#define COLOR_B_BASE_PATH 0,0,1,0.8
